      ...
      child: Row(
        children: [
          ...
          Expanded(child: Column(
            ...
            children: [
              const Text('小米5A', style: TextStyle(
    ...
    return ListView(
      ...
      children: [
        ...
        SizedBox(
          ...
          Container(padding: EdgeInsets.only(top: ScreenAdapter.height(20),bottom: ScreenAdapter.width(20)),
            decoration: BoxDecoration(
              color: Colors.white,
              borderRadius: BorderRadius.circular(ScreenAdapter.width(20)),
            ),
            child: Column(
              children: [
                _checkoutItem(),_checkoutItem(),_checkoutItem(),_checkoutItem(),_checkoutItem()
              ],
            ),
          ),
          SizedBox(height: ScreenAdapter.height(40),),
          Container(
            ...
            decoration: BoxDecoration(color: Colors.white,borderRadius: BorderRadius.circular(
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  trailing: Wrap(
                    children: [
                      Text('无可用'),Icon(Icons.navigate_next)
                    ],
                  ),
                ),
                ListTile(
      ...
      child: Row(
        ...
        children: [
          ...
          ElevatedButton(style: ButtonStyle(
            backgroundColor: MaterialStateProperty.all(Color.fromRGBO(251, 72, 5, 0.9)),
